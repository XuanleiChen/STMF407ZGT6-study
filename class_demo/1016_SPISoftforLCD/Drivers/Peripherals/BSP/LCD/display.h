	...
	extern void Display_Init(DISPLAY_DIRECTION displayDirection);																		//初始化
	...
	extern void Display_ShowPicture(u16 x, u16 y, u16 height, u16 width, const u8 pic[]);						//显示图片
	extern u16 Display24BitsTo16Bits(u32 color24Bytes);
	//画笔颜色
	#define WHITE         	 	0xFFFF
	#define BLACK         	 	0x0000
	#define BLUE           	 	0x001F
